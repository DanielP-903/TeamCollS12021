...
Shader "Toon/BasicToonShader"
{
	Properties
	{
		...
		_TexScale("Tex Scale", Float) = 0.27
		...
		_SketchBlend("Sketch Blend", Range( 0 , 1)) = 0.7
		_SketchSpeed("Sketch Speed", Float) = 3
		_SketchScaleDiff("Sketch Scale Diff", Float) = 0.3
	...
	SubShader
	{
		...
		uniform float _SketchScaleDiff;
		uniform float _SketchBlend;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 unityObjectToClipPos194 = UnityObjectToClipPos( ase_vertex3Pos );
			float4 computeScreenPos195 = ComputeScreenPos( unityObjectToClipPos194 );
			float4 unityObjectToClipPos193 = UnityObjectToClipPos( float3(0,0,0) );
			float4 computeScreenPos196 = ComputeScreenPos( unityObjectToClipPos193 );
			float4 transform203 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			float4 break213 = ( ( ( ( computeScreenPos195 / (computeScreenPos195).w ) * _TexScale ) - ( _TexScale * ( computeScreenPos196 / (computeScreenPos196).w ) ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform203 ) , float4( 0,0,0,0 ) ) );
			float4 break211 = _ScreenParams;
			float4 appendResult215 = (float4(( break213.x * ( break211.x / break211.y ) ) , break213.y , break213.z , break213.w));
			float4 temp_output_216_0 = (appendResult215*1.0 + ( floor( ( ( _Time.y * _SketchSpeed ) % 2.0 ) ) / 2.0 ));
			float4 lerpResult218 = lerp( tex2D( _SketchTex, temp_output_216_0.xy ) , tex2D( _SketchTex, ( temp_output_216_0 * _SketchScaleDiff ).xy ) , _SketchBlend);
			float4 temp_cast_5 = (_SketchBrightness).xxxx;
			float shadowArea147 = ( 1.0 - saturate( ase_lightAtten ) );
			float4 SketchMax122 = saturate( ( saturate( ( lerpResult218 - temp_cast_5 ) ) * shadowArea147 ) );
...
/*ASEBEGIN
Version=18912
0;0;1706.667;1045.667;5983.813;1153.713;6.597577;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;60;-2532.962,157.8931;Inherit;False;Property;_UseNormalMap;Use Normal Map?;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1311.999,992.0029;Float;False;Property;_RimPower;Rim Power;3;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;-250.9032,2624.931;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=30ED327A03F87D9A64BE0F5E1778F71DCEB394E2