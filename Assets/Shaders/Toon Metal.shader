	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_DiffuseMap = i.uv_texcoord * _DiffuseMap_ST.xy + _DiffuseMap_ST.zw;
				...
				float3 staticSwitch291 = tex2D( _DiffuseMap, uv_DiffuseMap ).rgb;
			#else
				float3 staticSwitch291 = _DiffuseColor.rgb;
			#endif
			float3 Diffuse293 = staticSwitch291;
			...
			float2 temp_cast_4 = (saturate( (NdotL77*0.5 + 0.5) )).xx;
			float4 tex2DNode6 = tex2D( _ToonRamp, temp_cast_4 );
			...
			float4 temp_output_23_0 = ( ( float4( Diffuse293 , 0.0 ) * tex2DNode6 ) * ( ase_lightColor * float4( ( indirectDiffuse11 + ase_lightAtten ) , 0.0 ) ) );
			...
			c.rgb = ( temp_output_23_0 + ( HightLight264 + ( ( saturate( tex2D( _T_Specular, i.uv_texcoord ).g ) * _SpecularMaskIntensity ) * step( _SpecularOffset , pow( saturate( dotResult243 ) , _Gloss ) ) ) ) ).rgb;
			c.a = 1;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 Rim81 = ( pow( ( 1.0 - saturate( dotResult265 ) ) , _RimPower ) * _RimColor );
...
/*ASEBEGIN
Version=18912
-1264;-400.3333;1242;785;-1009.649;-981.2635;3.542388;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;60;-2582.962,46.8931;Inherit;False;Property;_UseNormalMap;Use Normal Map?;4;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;287;-1319.409,2073.423;Inherit;False;1753.239;565.3416;Comment;14;238;237;277;243;281;276;239;286;279;246;255;254;278;280;Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.NormalizeNode;268;-1104.747,996.1563;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;294;-3097.917,503.4199;Inherit;False;Property;_DiffuseColor;Diffuse Color;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;239;-926.3694,2458.781;Inherit;False;Property;_Gloss;Gloss;14;0;Create;True;0;0;0;False;0;False;0.5;0.32;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;64;-836.0431,415.1302;Inherit;False;54;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;291;-2823.88,673.7834;Inherit;False;Property;_UseDiffuseMap;Use Diffuse Map?;1;0;Create;True;0;0;0;False;0;False;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;260;30.74499,1465.862;Inherit;False;Property;_HighLightOffset;HighLightOffset;18;0;Create;True;0;0;0;False;0;False;0.99;0.7;0.7;0.999;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;276;-431.8528,2123.423;Inherit;True;Property;_T_Specular;T_Specular;16;0;Create;True;0;0;0;False;0;False;-1;2595974fc7e57aa40b1154e753dc7b87;2595974fc7e57aa40b1154e753dc7b87;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;263;313.745,1726.862;Inherit;False;Property;_HighLightColor;HighLightColor;19;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;272;-627.9451,1015.748;Inherit;False;Property;_RimPower;Rim Power;13;0;Create;True;0;0;0;False;0;False;2;0;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;246;-762.2335,2408.968;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;293;-2522.266,674.6588;Inherit;False;Diffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;279;-242.2036,2321.042;Inherit;False;Property;_SpecularMaskIntensity;Specular Mask Intensity;17;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;255;-729.9038,2298.999;Inherit;False;Property;_SpecularOffset;Specular Offset;15;0;Create;True;0;0;0;False;0;False;0.98;0;0;0.99;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;270;-636.7314,879.0326;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;271;-404.6145,881.6583;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;275;-300.7814,1003.361;Float;False;Property;_RimColor;Rim Color;12;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;2,2,2,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LightColorNode;8;-720.676,302.1136;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;295;-177.653,-230.389;Inherit;False;293;Diffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;75.47929,-99.83525;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;273;-103.9022,881.281;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;283;2227.532,1976.838;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;81;75.69028,875.4769;Inherit;False;Rim;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;219;2346.214,4072.665;Inherit;False;Property;_SketchBlend;Sketch Blend;9;0;Create;True;0;0;0;False;0;False;0.7;0.7;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;229;1565.617,4086.299;Inherit;False;Property;_SketchScaleDiff;Sketch Scale Diff;11;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;222;893.7811,4559.637;Inherit;False;Property;_SketchSpeed;Sketch Speed;10;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;95;872.5161,475.5286;Inherit;False;-1;;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A901058A48617459E4002A343558910C0E455FCF