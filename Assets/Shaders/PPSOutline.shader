...
Shader "PPS/Outline"
{
	Properties
	{
		...
		_NormalMulti("NormalMulti", Float) = 2
		_DepthMulti1("DepthMulti", Float) = 450
		_NormalPower("NormalPower", Float) = 40
		_DepthPower1("DepthPower", Float) = 10
		_OutlineColor("Outline Color", Color) = (0.9245283,0.738364,0.248576,0)
		_NormalMaskMulti("Normal Mask Multi", Float) = 0.2
	...
	SubShader
	{
		...
		{ 
			...
			uniform float _NormalMaskMulti;
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float DepthMask284 = saturate( pow( ( ( abs( ( centerDepth182 - clampResult111 ) ) + abs( ( centerDepth182 - clampResult119 ) ) + abs( ( centerDepth182 - clampResult128 ) ) + abs( ( centerDepth182 - clampResult137 ) ) ) * _DepthMulti1 ) , _DepthPower1 ) );
				float depthDecodedVal243 = 0;
				float3 normalDecodedVal243 = float3(0,0,0);
				DecodeDepthNormal( tex2D( _CameraDepthNormalsTexture, localCenter52 ), depthDecodedVal243, normalDecodedVal243 );
				float3 centerNormal251 = normalDecodedVal243;
				float2 appendResult233 = (float2(0.0 , localStepY31));
				float depthDecodedVal258 = 0;
				float3 normalDecodedVal258 = float3(0,0,0);
				DecodeDepthNormal( tex2D( _CameraDepthNormalsTexture, ( localCenter52 + appendResult233 ) ), depthDecodedVal258, normalDecodedVal258 );
				float2 appendResult227 = (float2(localStepX33 , 0.0));
				float depthDecodedVal257 = 0;
				float3 normalDecodedVal257 = float3(0,0,0);
				DecodeDepthNormal( tex2D( _CameraDepthNormalsTexture, ( localCenter52 + appendResult227 ) ), depthDecodedVal257, normalDecodedVal257 );
				float2 appendResult228 = (float2(0.0 , localNegStepY38));
				float depthDecodedVal253 = 0;
				float3 normalDecodedVal253 = float3(0,0,0);
				DecodeDepthNormal( tex2D( _CameraDepthNormalsTexture, ( localCenter52 + appendResult228 ) ), depthDecodedVal253, normalDecodedVal253 );
				float2 appendResult229 = (float2(localNegStepX69 , 0.0));
				float depthDecodedVal256 = 0;
				float3 normalDecodedVal256 = float3(0,0,0);
				DecodeDepthNormal( tex2D( _CameraDepthNormalsTexture, ( localCenter52 + appendResult229 ) ), depthDecodedVal256, normalDecodedVal256 );
				float3 temp_output_275_0 = ( abs( ( centerNormal251 - normalDecodedVal258 ) ) + abs( ( centerNormal251 - normalDecodedVal257 ) ) + abs( ( centerNormal251 - normalDecodedVal253 ) ) + abs( ( centerNormal251 - normalDecodedVal256 ) ) );
				float NormalMask285 = pow( ( (temp_output_275_0).x * _NormalMulti ) , _NormalPower );
				float4 lerpResult304 = lerp( _OutlineColor , tex2D( _MainTex, uv_MainTex ) , saturate( ( 1.0 - ( DepthMask284 + ( NormalMask285 * _NormalMaskMulti ) ) ) ));
...
/*ASEBEGIN
Version=18912
-1920;-628.3333;1920;1029;-1473.663;-350.5945;1.238225;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-785.3668,-617.8393;Inherit;False;Property;_SampleStep;SampleStep;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-887.3156,-358.4974;Inherit;False;Property;_MaxDepth;MaxDepth;1;0;Create;True;0;0;0;False;0;False;5000;5000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;2778.639,1221.875;Inherit;False;Property;_NormalMulti;NormalMulti;3;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;279;2779.231,-668.3068;Inherit;False;Property;_DepthMulti1;DepthMulti;4;0;Create;True;0;0;0;False;0;False;450;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;281;2883.976,-837.0129;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;282;2982.231,-666.3068;Inherit;False;Property;_DepthPower1;DepthPower;6;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;3019.639,1223.875;Inherit;False;Property;_NormalPower;NormalPower;5;0;Create;True;0;0;0;False;0;False;40;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;213;3092.639,1053.875;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;283;3055.231,-836.3058;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;296;3240.612,-838.5791;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;284;3435.207,-838.2505;Inherit;False;DepthMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;299;3000.783,46.88831;Inherit;False;285;NormalMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;305;2986.783,131.8883;Inherit;False;Property;_NormalMaskMulti;Normal Mask Multi;8;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;306;3193.783,66.88831;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;300;3163.783,-67.11169;Inherit;False;284;DepthMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;307;3350.783,8.888306;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;302;3493.783,10.88831;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;298;3690.218,-387.7812;Inherit;False;Property;_OutlineColor;Outline Color;7;0;Create;True;0;0;0;False;0;False;0.9245283,0.738364,0.248576,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;4206.847,-233.0143;Float;False;True;-1;2;ASEMaterialInspector;0;2;PPS/Outline;c71b220b631b6344493ea3cf87110c93;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;True;7;False;-1;False;True;0;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=39CDE39104AABE5FC80523772DB66F83F8808FFE